...
var UserService = (function () {
    ...
    UserService.prototype.getMedecins = function () {
    ...
    UserService.prototype.getcreneaux = function (id_medecin, date) {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();
        ...
        var body = "id_medecin=" + id_medecin + "&date=" + date;
        console.log(body);
        console.log("azerty");
        return this.http.put('http://localhost:8089/getcreneaux', body, options)
            .map(function (response) { return response.json(); });
    };
    UserService.prototype.getmedicament = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();
    ...
    UserService.prototype.getOrdonnances = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();
    ...
    UserService.prototype.chargerprescriptionglobale = function (idOrdonnanceglobale) {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();
        ...
        headers.append('content-type', 'application/x-www-form-urlencoded');
        var options = new http_1.RequestOptions({ headers: headers });
        var body = "idOrdonnanceglobale=" + idOrdonnanceglobale;
        return this.http.put('http://localhost:8089/chargerprescriptionglobale', body, options)
            .map(function (response) { return response.json(); });
    };
    UserService.prototype.getActeurs = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();
    ...
    UserService.prototype.getpatients = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var username = currentUser.username;
        var password = currentUser.password;
        var headers = new http_1.Headers();

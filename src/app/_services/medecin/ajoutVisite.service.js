...
var AjoutVisiteService = (function () {
    function AjoutVisiteService(http) {
        // set token if saved in local storage
        // var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        //   this.token = currentUser && currentUser.token;
        this.http = http;
    }
    AjoutVisiteService.prototype.ajoutOrdonnance = function (visite) {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
    ...
    return AjoutVisiteService;
}());
AjoutVisiteService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], AjoutVisiteService);
exports.AjoutVisiteService = AjoutVisiteService;
//# sourceMappingURL=ajoutVisite.service.js.map
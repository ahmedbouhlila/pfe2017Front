...
var ValiderFactureService = (function () {
    function ValiderFactureService(http) {
        this.http = http;
    }
    ValiderFactureService.prototype.validation = function (montant, id, details) {
    ...
    return ValiderFactureService;
}());
ValiderFactureService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], ValiderFactureService);
exports.ValiderFactureService = ValiderFactureService;
//# sourceMappingURL=validerfacture.service.js.map
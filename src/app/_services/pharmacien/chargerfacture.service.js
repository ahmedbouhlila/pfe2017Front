...
var ChargerFactureService = (function () {
    function ChargerFactureService(http) {
        this.http = http;
    }
    ChargerFactureService.prototype.chargerfacture = function (id_visite) {
    ...
    return ChargerFactureService;
}());
ChargerFactureService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], ChargerFactureService);
exports.ChargerFactureService = ChargerFactureService;
//# sourceMappingURL=chargerfacture.service.js.map
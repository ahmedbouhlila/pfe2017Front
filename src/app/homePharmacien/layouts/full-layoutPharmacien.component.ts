...
@Component({
  ...
  templateUrl: './full-layoutPharmacien.component.html'
})
export class FullLayoutPharmacienComponent implements OnInit {
...
case 3 :
   ...
   this.role="Pharmacien";
    break;
     ...
     this.router.navigate(['/homePharmacien/acceuil']);
  }
}
